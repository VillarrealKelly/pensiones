			...
			<div class="row">
				...
				<div class="form-group">
  				...
  				<div class="col-md-6">
					...
					<select   name="est_paralelo" id="est_paralelo" class="form-control">
  				...
  				<div class="col-md-6">
					...
					<select   name="est_especialidad" id="est_especialidad" class="form-control">
  				...
  				<div class="col-md-6">
					...
					<input type="date" name="est_fecha" id="est_fecha" class="form-control" >
  				</div>
