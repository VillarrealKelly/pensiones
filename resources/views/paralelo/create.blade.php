...
<div class="container">
	<div class="row justify-content-center">
		...
		<div class="card-body">	 
		<form action="{{route('paralelo.store')}}" method="POST" onsubmit="return validar()">
			@csrf
<div class="container">
	<div class="row">
	<div class="col-md-8">
		<div class="form-group">
				    ...
				    <input type="text" name="par_detalle" id="par_detalle" class="form-control @error('par_detalle') is-invalid @enderror" name="par_detalle" value="{{ old('par_detalle') }}" required autocomplete="par_detalle" autofocus placeholder="Escriba el nuevo paralelo">
